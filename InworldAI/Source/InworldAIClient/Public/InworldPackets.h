...
public:
	...
	virtual void Visit(const FInworldControlEventConversationUpdate& Event) {  }
...
USTRUCT()
struct INWORLDAICLIENT_API FInworldControlEventConversationUpdate : public FInworldControlEvent
{
	GENERATED_BODY()

	FInworldControlEventConversationUpdate() = default;
	virtual ~FInworldControlEventConversationUpdate() = default;
