...
public:
	...
	virtual void Visit(const Inworld::ControlEventConversationUpdate& Event) override { MakePacket<Inworld::ControlEventConversationUpdate, FInworldControlEventConversationUpdate>(Event); }
