...
public:
	...
	virtual void Visit(const Inworld::A2FAnimationContentEvent& Event) override { MakePacket<Inworld::A2FAnimationContentEvent, FInworldA2FAnimationContentEvent>(Event); }
