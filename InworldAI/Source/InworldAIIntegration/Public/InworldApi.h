...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Inworld", meta = (AdvancedDisplay = "4", DeprecatedFunction, DeprecationMessage = "Function has been deprecated, Please use StartSession."))
